...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private var b11D: Int = 0
    private var b2D: Int = 0
    private var b4D: Int = 0
    private var b5D: Int = 0
    private var b6D: Int = 0
    private var b8D: Int = 0
    private var b9D: Int = 0
    private var b111D: Int = 0
    private var b12D: Int = 0
    private var b13D: Int = 0
    private var b15D: Int = 0
    private var b16D: Int = 0
    private var b18D: Int = 0
    private var b19D: Int = 0
    private var b20D: Int = 0
    private var b22D: Int = 0
    private var b23D: Int = 0
    private var b25D: Int = 0
    private var b26D: Int = 0
    private var b27D: Int = 0
    private var b29D: Int = 0
    private var b30D: Int = 0
    private var b32D: Int = 0
    private var b33D: Int = 0
    private var b34D: Int = 0
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.p35 ->
                soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b1 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b2 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.bt4 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.bt5 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.bt6 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b8 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b9 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.bt11 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b12 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b13 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b15 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b16 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b18 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b19 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b20 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b22 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b23 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b25 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b26 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b27 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b29 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b30 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b32 -> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b33-> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
            R.id.b34-> soundPool.play(e7, 1f, 1f, 0, 0, 1f)
    ...
    private fun sounds() {
        ...
        c5 = soundPool.load(this, R.raw.b4, 1);
        ...
        c6 = soundPool.load(this, R.raw.c5, 1);
        ...
        b11D = soundPool.load(this, R.raw.a0, 1);
        b2D = soundPool.load(this, R.raw.a1, 1);
        b4D = soundPool.load(this, R.raw.c1, 1);
        b5D = soundPool.load(this, R.raw.d1, 1);
        b6D = soundPool.load(this, R.raw.g1, 1);
        b8D = soundPool.load(this, R.raw.a2, 1);
        b9D = soundPool.load(this, R.raw.c2, 1);
        b111D = soundPool.load(this, R.raw.d2, 1);
        b12D = soundPool.load(this, R.raw.a3black, 1);
        b13D = soundPool.load(this, R.raw.c3, 1);
        b15D = soundPool.load(this, R.raw.g3, 1);
        b16D = soundPool.load(this, R.raw.c4black, 1);
        b18D = soundPool.load(this, R.raw.d4black, 1);
        b19D = soundPool.load(this, R.raw.e4, 1);
        b20D = soundPool.load(this, R.raw.f4black, 1);
        b22D = soundPool.load(this, R.raw.g4black, 1);
        b23D = soundPool.load(this, R.raw.a5black, 1);
        b25D = soundPool.load(this, R.raw.c5, 1);
        b26D = soundPool.load(this, R.raw.f5black, 1);
        b27D = soundPool.load(this, R.raw.g5black, 1);
        b29D = soundPool.load(this, R.raw.a6black, 1);
        b30D = soundPool.load(this, R.raw.c6black, 1);
        b32D = soundPool.load(this, R.raw.d6black, 1);
        b33D = soundPool.load(this, R.raw.g6black, 1);
        b34D = soundPool.load(this, R.raw.f6black, 1);
